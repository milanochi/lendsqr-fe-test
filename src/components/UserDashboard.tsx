...
const UserDashboard = () => {
  ...
  const [userPerPage, setUserPerPage] = useState([10, 15, 20, 25, 30 , 35, 40, 45, 50])
  ...
  return (
    <div>
       ...
       <section className='info'>
          ...
          <table>
            <thead>
              <tr>
                ...
                <td>STATUS<img src={Filter} onClick={showFilter} className='dots' alt='filter'/>
        ...
        <Pagination user={users.length} add={Add} handleTotalPage={handleTotalPage} pageCount={pageCount} itemsPerPage={itemsPerPage} setItemsPerPage={setItemsPerPage} setItemOffset={setItemOffset}/>
    </div>
  )
}
